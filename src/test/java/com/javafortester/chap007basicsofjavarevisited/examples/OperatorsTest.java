...
public class OperatorsTest {
    ...
    public void assignmentOperatorsExplored(){
        ...
        num += 2;
        assertEquals("+= increments the variable num by 2", 12, num);

        num -= 4;
        assertEquals("-= decrements the variable num by 4", 8, num);

        num *= 2;
        assertEquals("*= multiplies the variable num by 2", 16, num);

        num /= 4;
        assertEquals("/= divides the variable num by 4", 4, num);
